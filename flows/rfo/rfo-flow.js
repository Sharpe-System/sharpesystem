...
function renderReview(ctx) {
  ...
  ctx.stageEl.innerHTML = ""
    ...
    + "<div style=\"white-space:pre-wrap;\">" + esc(pub.decl?.facts || "") + "</div>"
    + "</div>"
    + "<div class=\"ss-card\" style=\"margin-top:12px;\">"
    + "<div><strong>Recent</strong></div>"
    + "<div style=\"white-space:pre-wrap;\">" + esc(pub.decl?.recent || "") + "</div>"
    + "</div>"
    + "<div class=\"ss-card\" style=\"margin-top:12px;\">"
    + "<div><strong>Necessity</strong></div>"
    + "<div style=\"white-space:pre-wrap;\">" + esc(pub.decl?.necessity || "") + "</div>"
    + "</div>"
    + "<div class=\"ss-card\" style=\"margin-top:12px;\">"
    + "<div><strong>Relief</strong></div>"
    + "<div style=\"white-space:pre-wrap;\">" + esc(pub.decl?.relief || "") + "</div>"
    + "</div>"
    + "<div class=\"ss-card\" style=\"margin-top:12px;\">"
