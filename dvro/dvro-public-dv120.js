/* /dvro/rfo-public-dv120.js
   Public DV-120 mapping + shared MC-030 overflow handling
...
(function () {
  ...
  async function mountFieldAssist() {
    try {
      ...
      root.addEventListener("click", (e) => {
        const applyBtn = root.querySelector('[data-field="dv120.ordersRequested"][data-apply-to="ordersRequested"]');
        if (!applyBtn) return;
  ...
  const KEY_FL300 = "ss_dvro_dv120_v1";
